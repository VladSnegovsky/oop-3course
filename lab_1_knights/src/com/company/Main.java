...
public class Main {
    public static void main(String[] args) throws ClassNotFoundException, SQLException, InterruptedException {
        ...
        RoundTable.knights[0] = new Knight("Arthur Pendragon", openShop);
        ...
        if (num == 1){
            ...
            Thread.sleep(3000);
            RoundTable Table = new RoundTable("a", openShop);
            Table.addKnights(openShop);
        ...
        while (!exit){
            ...
            if (choice == 7)
                ...
                int max = sh.nextInt();
                DataBase.ShowByCost(min, max, choice, openShop);
            }
        }
    }
}
